...
export const projects: Project[] = [
	{
		name: 'portfolio-tech',
		description: {
			es: 'Este mismo portfolio: estética de terminal construida con Astro, TypeScript y Tailwind.',
			en: 'This very portfolio: terminal aesthetics built with Astro, TypeScript and Tailwind.',
		},
